import { emptyCopyObject } from "./copy.js";

export function strucureAssociation(
  currentObjects,
  viewObjects,
  associationName,
  fromCollectionName,
...
export function strucureList(currentObjects, viewObjects, collectionName) {
  emptyCopyObject(currentObjects, viewObjects);
...
export function strucureOneWay(
  currentObjects,
  viewObjects,
  relationName,
  fromCollectionName,
